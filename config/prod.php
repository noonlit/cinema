...
//$result = $test->loadByProperties(array('id' => 1));

var_dump($result);

/*$test = new Entity\EntityFactory();
$m = $test->createFromArray('schedule', array('date' => '10.11.2015'));


$format = 'd.m.Y h:m:s';
$value = \DateTime::createFromFormat($format, '10.11.2015 00:00:00');
var_dump($m);
