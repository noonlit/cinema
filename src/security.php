...
$app->register(
    ...
    array(
        'security.firewalls'      => array(
            'secured' => array(
                ...
                'form'      => array(
                    ...
                    //auth_dologin route is automatically defined by Silex and its
                    ...
                    //after a successfull login, the user is
                    'always_use_default_target_path' => true,
                    //redirected to a last accesed page
                    'username_parameter'             => 'email',
                    'password_parameter'             => 'password',
                ),
                'logout'    => array('logout_path' => '/logout'),
                // route is automatically generated, based on the configured path
                //            'logout' => true,
                'anonymous' => true,
                //annonymous users are allowed to access all pages
        ...
        'security.access_rules'   => array(
            ...
            //in order to access paths that begin with /admin, the user must be administrator
            array('^/user.*', 'ROLE_USER'),
            //in order to access paths that begin with /user, the user must be a regular user
        ),
    )
);
